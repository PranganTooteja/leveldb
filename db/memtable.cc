...
MemTable::MemTable(const InternalKeyComparator& comparator)
    : comparator_(comparator), refs_(0), table_(comparator_, &arena_), table1_(comparator_, &arena1_) {}
...
Iterator* MemTable::NewSecondIterator() { return new MemTableIterator(&table1_); }
